...
-- 
-- indexes count from zero to n-1
sn :: Int
--sn = sqrtNumGridVals
sn = 3
...
secondSet = [(makeIndex val i j x y , makeIndex val i j u v) | u <- [0..(sn-1)]
                                                             , v <- [0..(sn-1)]
                                                             , (i,j,x,y) <- ijxy
                                                             , val <- [0..(n-1)]
                                                             , not (u == x && v == y) ]
...
thirdSet = [(makeIndex val i j x y , makeIndex val u j v y) | u <- [0..(sn-1)]
                                                            , v <- [0..(sn-1)]
                                                            , (i,j,x,y) <- ijxy
                                                            , val <- [0..(n-1)]
                                                            , not (u == i && v == x) ]
...
fourthSet = [(makeIndex val i j x y , makeIndex val i u x v) | u <- [0..(sn-1)]
                                                             , v <- [0..(sn-1)]
                                                             , (i,j,x,y) <- ijxy
                                                             , val <- [0..(n-1)]
                                                             , not (u == j && v == y) ]
